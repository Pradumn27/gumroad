...
type Props = {
  defaultInstallments: ScheduledInstallment[];
  defaultPagination: Pagination;
};

export const ScheduledTab = ({ defaultInstallments, defaultPagination }: Props) => {
                  ...
                  >
                    ...
                    <td data-label="Delivery Time" className="whitespace-nowrap">
                      {new Date(installment.to_be_published_at).toLocaleTimeString(userAgentInfo.locale, {
                        ...
                        minute: "numeric",
                        timeZone: currentSeller.timeZone.name,
                        year: "numeric", // Added to ensure uniqueness if date spans years but key is day? No, date key is already day.
                      })}
                    </td>
                  </tr>
                ))}
