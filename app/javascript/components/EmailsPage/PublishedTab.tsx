...
type Props = {
  defaultInstallments: PublishedInstallment[];
  defaultPagination: Pagination;
};

export const PublishedTab = ({ defaultInstallments, defaultPagination }: Props) => {
  const [installments, setInstallments] = React.useState(defaultInstallments);
  ...
  }, [defaultInstallments, defaultPagination]);
      ...
      {installments.length > 0 ? (
        <>
              ...
              {installments.map((installment) => (
                ...
                >
                  ...
                  <td data-label="Opened" className="whitespace-nowrap">
                    {installment.send_emails ? formatStatNumber({ value: installment.open_rate, suffix: "%" }) : "n/a"}
                  </td>
          ...
          {deletingInstallment ? (
            ...
            >
              <h4>
                Are you sure you want to delete the email "{deletingInstallment.name}"? Customers who had access will no
                longer be able to see it. This action cannot be undone.
              </h4>
            </Modal>
          ) : null}
        </>
